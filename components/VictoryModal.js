...
export default function VictoryModal({ prizeName, onClose }) {
  return (
    <div
    ...
    >
      <div className="relative w-full max-w-sm animate-pop-in rounded-3xl border-4 border-brand-500 bg-white p-8 text-center shadow-2xl">
        ...
        <h2 id="victory-title" className="mt-2 font-display text-2xl text-ink-900">
          You won
        </h2>
